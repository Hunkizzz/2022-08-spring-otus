package ru.education.spring.batch.demo.config;
...
import ru.education.spring.batch.demo.domain.Author;
import ru.education.spring.batch.demo.domain.Book;
import ru.education.spring.batch.demo.domain.Comment;
import ru.education.spring.batch.demo.domain.Genre;
import ru.education.spring.batch.demo.dto.CommentDTO;
import ru.education.spring.batch.demo.processor.CommentDTOProcessor;
...
public class JobConfig {
    ...
    public Job migrateMongoToH2() {
        return jobBuilderFactory.get("migrateMongoToH2")
                .start(authorStep())
                .next(genreStep())
                .next(bookStep())
                .next(commentStep())
